...
func (m *fakeManager) GetTopologyHints(logger logr.Logger, pod *v1.Pod, container *v1.Container, operation lifecycle.Operation) map[string][]topologymanager.TopologyHint {
	logger.Info("Get container topology hints", "operation", operation)
	return map[string][]topologymanager.TopologyHint{}
}

func (m *fakeManager) GetPodTopologyHints(logger logr.Logger, pod *v1.Pod, operation lifecycle.Operation) map[string][]topologymanager.TopologyHint {
	logger.Info("Get pod topology hints", "operation", operation)
	return map[string][]topologymanager.TopologyHint{}
}

func (m *fakeManager) AllocatePod(logger logr.Logger, pod *v1.Pod, operation lifecycle.Operation) error {
