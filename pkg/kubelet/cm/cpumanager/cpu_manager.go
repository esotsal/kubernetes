...
type Manager interface {
	...
	GetTopologyHints(logger logr.Logger, pod *v1.Pod, container *v1.Container, operation lifecycle.Operation) map[string][]topologymanager.TopologyHint
	...
	AllocatePod(logger logr.Logger, pod *v1.Pod, operation lifecycle.Operation) error
...
func (m *manager) GetTopologyHints(logger logr.Logger, pod *v1.Pod, container *v1.Container, operation lifecycle.Operation) map[string][]topologymanager.TopologyHint {
